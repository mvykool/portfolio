...
const Layout = ({children}: Props) => {
  ...
  <main className='w-5/6 md:w-3/6 mx-auto mt-2 md:mt-10 h-screen'>
  {children}
  </main>

<div id='about' className='w-5/6 md:w-3/6 pt-10 md:pt-1 mx-auto mt-5'>
<About setSelectedPage={setSelectedPage}/>
</div>

<div id='experience' className='w-11/12 md:w-3/6 pt-10 md:pt-20  mx-auto mt-0 md:mt-10'>
