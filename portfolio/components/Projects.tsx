      ...
      <div className="flex justify-center">
        ...
        variants={{
          ...
          visible: { opacity: 1, x: 0 },
              ...
              <p className="text-sm md:text-xs mb-2 text-gray-500 mx-2">Fully functional shopping cart, <span className="text-app-green font-semibold">payments with Stripe</span>, authentication handled with Fireauth, blog posts, functional chat &  email service.</p>
