      ...
      <div className="flex justify-center">
        ...
        variants={{
          ...
          visible: { opacity: 1, x: 0 },
              ...
              <div className="hover:scale-95 duration-200 transition bg-app-gray rounded-sm  p-3 relative md:h-[60vh]  cursor-pointer">
      ...
      <motion.div
        ...
        variants={{
          ...
          visible: { opacity: 1, x: 0 },
           ...
           <Image width={700} height={500} src="/project2.png" alt="airman" className=" object-cover rounded-sm  object-left h-[40vh] md:h-[20vh] md:w-full" />
              ...
              <div className="flex justify-center mt-5 lute md:bottom-0 md:absolute md:w-full">
        ...
        variants={{
          ...
          visible: { opacity: 1, x: 0 },
             ...
             <div className="hover:scale-95 duration-200 transition  rounded-sm bg-app-gray p-3 relative md:h-[60vh]  cursor-pointer">
             <Image width={700} height={500} src="/project3.png" alt="airman" className=" object-cover rounded-sm object-right h-[40vh] md:h-[20vh]" />
              ...
              <div className="flex justify-center mt-5 lute md:bottom-3 md:absolute md:w-full">
