...
const SideRight = () => {
  return (
    <div className='flex flex-col gap-2 fixed top-[50%] left-10 '>
      <a href="https://github.com/mvykool" target="_blank">
