            ...
            >
              <div className="hover:scale-95 duration-200 transition bg-app-gray rounded-sm  p-3 relative md:h-[65vh] xl:h-[55vh] cursor-pointer">
                <Image
                  ...
                  src="/project1.png"
                  alt="airman"
                  className="object-left object-cover rounded-sm  h-[40vh] md:h-[20vh]"
                />
                <p className="my-5 flex justify-center font-bold text-2xl">
              ...
              my-5 ml-2 md:text-xs md:justify-center"
                ...
                <p className="text-sm mb-2 text-gray-300 mx-2">
                ...
                <div className="flex justify-center mt-5 md:bottom-0 md:absolute md:w-full">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center m-5 border-2 border-white rounded-sm justify-center md:text-sm py-1 px-2 hover:scale-125 duration-200 transition hover:bg-white hover:text-deep-blue"
                  >
                    Live
            ...
            >
              <div className="hover:scale-95 duration-200 transition bg-app-gray rounded-sm p-3 relative md:h-[65vh] xl:h-[55vh] cursor-pointer">
                <Image
                  ...
                  src="/project2.png"
                  alt="airman"
                  className=" object-cover rounded-sm  object-left h-[40vh] md:h-[20vh] md:w-full"
                />
                <p className="my-5 flex justify-center font-bold text-2xl">
            ...
            >
              <div className="hover:scale-95 duration-200 transition  rounded-sm bg-app-gray p-3 relative md:h-[65vh] xl:h-[55vh] cursor-pointer">
                <Image
                  ...
                  src="/project3.png"
                  alt="airman"
                  className=" object-cover rounded-sm object-right h-[40vh] md:h-[20vh]"
                />
                <p className="my-5 flex justify-center font-bold text-2xl">
            ...
            >
              <div className="hover:scale-95 duration-200 transition  rounded-sm bg-app-gray p-3 relative md:h-[65vh] xl:h-[55vh]  cursor-pointer">
                <Image
                  ...
                  src="/open-sesamo.png"
                  alt="airman"
                  className=" object-fill rounded-sm  h-[40vh] md:h-[20vh]"
                />
                <p className="my-5 flex justify-center font-bold text-2xl gap-2">
